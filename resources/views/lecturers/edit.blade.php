...
@section('breadcrumb', 'Edit Lecturer')

@section('content')
<div class="max-w-6xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-900">Edit Lecturer</h2>
        <p class="mt-1 text-sm text-gray-600">Update lecturer profile with multilingual content support</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('lecturers.update', $lecturer) }}" method="POST" enctype="multipart/form-data" id="lecturer-edit-form">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               id="position_title"
                               name="position_title"
                               value="{{ old('position_title', $lecturer->position_title) }}"
                    ...
                    <div>
                        ...
                        <input type="url"
                               id="scholar_url"
                               name="scholar_url"
                               value="{{ old('scholar_url', $lecturer->scholar_url) }}"
                    ...
                    <div>
                        ...
                        <input type="url"
                               ...
                               value="{{ old('researchgate_url', $lecturer->researchgate_url) }}"
                    ...
                    <div>
                        ...
                        <input type="url"
                               id="linkedin_url"
                               name="linkedin_url"
                               value="{{ old('linkedin_url', $lecturer->linkedin_url) }}"
                    ...
                    <div>
                        ...
                        @if($lecturer->photo)
                        <p class="mt-1 text-xs text-gray-500">Current photo: <img src="{{ $lecturer->photo_url }}" alt="Current photo" class="h-10 w-10 rounded-full object-cover inline"></p>
                        @endif
                        <p class="mt-1 text-xs text-gray-500">Upload new profile photo. Recommended size: 300x300px.</p>
                        @error('photo')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    @foreach ($languages as $language)
                        @php
                            $translation = $lecturer->translations->where('locale', $language->code)->first();
                        @endphp
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('translations.' . $language->code . '.full_name', $translation->full_name ?? '') }}"
                                ...
                                <div>
                                    ...
                                    <textarea id="bio_html_{{ $language->code }}"
                                              ...
                                              placeholder="Enter biography">{{ old('translations.' . $language->code . '.bio_html', $translation->bio_html ?? '') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="research_interests_{{ $language->code }}"
                                              ...
                                              placeholder="Enter research interests">{{ old('translations.' . $language->code . '.research_interests', $translation->research_interests ?? '') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="achievement_{{ $language->code }}"
                                              ...
                                              placeholder="Enter achievements">{{ old('translations.' . $language->code . '.achievement', $translation->achievement ?? '') }}</textarea>
                    ...
                    <div class="flex items-center space-x-6">
                        <label class="flex items-center">
                            <input type="checkbox"
                                   name="featured"
                                   value="1"
                                   {{ old('featured', $lecturer->featured) ? 'checked' : '' }}
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                    <i class="fas fa-save mr-2"></i>Update Lecturer with All Translations
                </button>
            </div>
        </form>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Edit lecturer loaded, initializing CKEditor for all languages...');
    ...
    const form = document.getElementById('lecturer-edit-form');
    if (form) {
