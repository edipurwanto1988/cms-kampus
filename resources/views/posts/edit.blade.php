...
<div class="max-w-6xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Update post details, image, and language</p>
    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="category_id"
                            ...
                            @foreach($categoryOptions as $categoryId => $categoryName)
                                <option value="{{ $categoryId }}" {{ old('category_id', $post->category_id) == $categoryId ? 'selected' : '' }}>
                                    {{ $categoryName }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @if($post->coverMedia)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $post->coverMedia->path) }}" alt="Current cover" class="max-w-xs h-auto rounded">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea id="excerpt_{{ $language->code }}"
                                              ...
                                              placeholder="Brief description of post">{{ old('translations.' . $language->code . '.excerpt', $translation->excerpt ?? '') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="content_{{ $language->code }}"
                                              ...
                                              placeholder="Enter post content">{{ old('translations.' . $language->code . '.content', $translation->content_html ?? '') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="meta_description_{{ $language->code }}"
                                              ...
                                              placeholder="SEO meta description">{{ old('translations.' . $language->code . '.meta_description', $translation->meta_description ?? '') }}</textarea>
